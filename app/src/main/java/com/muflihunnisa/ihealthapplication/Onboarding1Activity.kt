...
class Onboarding1Activity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_onboarding1.setOnClickListener(this)
        tv_onboarding1_skip.setOnClickListener(this)
    }

    override fun onClick(p0: View) {
        when(p0.id){
            R.id.btn_onboarding1 -> startActivity(Intent(Onboarding2Activity.getLaunchService(this)))
            R.id.tv_onboarding1_skip -> startActivity(Intent(LoginActivity.getLaunchService(this)))
        }
    }
}